...
from dataset.waymo.waymo_dataset_de import WaymoDatasetDe
...
def data_process(args):
    if 0:
        ...
        dataset = WaymoDatasetDe(base_dir=waymo_dir, caption_offline_dir=caption_offline_dir, 
                            num_frames=81, point_size=2, output_dir="waymo_output", num_clips=args.num_clips)
