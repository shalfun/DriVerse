...
class WanVideoPipeline(BasePipeline):
    ...
    def __call__(
        ...
        for progress_id, timestep in enumerate(progress_bar_cmd(self.scheduler.timesteps)):
            ...
            # Inference
            noise_pred_posi = self.dit(latents, tracking_maps=tracking_maps, timestep=timestep, **prompt_emb_posi, **image_emb, **extra_input)
            if cfg_scale != 1.0:
                noise_pred_nega = self.dit(latents, tracking_maps=tracking_maps, timestep=timestep, **prompt_emb_nega, **image_emb, **extra_input)
